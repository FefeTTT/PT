...
(function () {
    function crearMenuTrimestres(adminMenu) {
        ...
        const actions = [
            { id: 'importar-uea', label: 'Importar UEA', handler: 'navImportarUEA' },
        ...
        if (window.Swal) {
            ...
            const render = (q) => {
                ...
                if (incluirTodos) {
                    ...
                    c.addEventListener('change', () => {
                        if (c.checked) {
                            current = ['ALL']; // seleccionar sólo ALL
...
function navImportarUEA() {
    window.location.href = 'scripts/formImportarUEA.php';
}
try { if (typeof window !== 'undefined') window.navImportarUEA = navImportarUEA; } catch (e) { }
