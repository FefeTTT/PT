...
import { ContextoRegla, ReglaBase } from '../rules/ReglaBase';
...
export class GraphFSMAsignador extends FSMAsignador {
    ...
    public procesarAsignacionStepByStep(numeroEconomico: number, idUeaGrupo: number, contexto?: ContextoRegla): StepSnapshot[] {
