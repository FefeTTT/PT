...
export class ReglasPipeline {
     ...
     * Incluye ReglaIgnorarGrupos al final como defensa en profundidad (espejo de
     * solution/rules/ReglasPipeline.ts): la EjectionChain valida solo con estas reglas y los
     * SAI/CPRO no deben colarse por ahí.
