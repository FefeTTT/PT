...
function crearGrafoMinimo(): GrafoBipartito {
    ...
    const grupos: GrupoDTO[] = [
        { idUeaGrupo: 100, idGrupo: 1, claveGrupo: 'T01', idArea: 1, ueaClave: 10, horarios: [{ dia: 1, horaInicio: 8, horaFin: 10 }] },
        { idUeaGrupo: 101, idGrupo: 2, claveGrupo: 'T02', idArea: 1, ueaClave: 10, horarios: [{ dia: 1, horaInicio: 10, horaFin: 12 }] },
        { idUeaGrupo: 102, idGrupo: 3, claveGrupo: 'T03', idArea: 1, ueaClave: 11, horarios: [{ dia: 2, horaInicio: 8, horaFin: 10 }] },
        { idUeaGrupo: 103, idGrupo: 4, claveGrupo: 'T04', idArea: 1, ueaClave: 11, horarios: [{ dia: 2, horaInicio: 10, horaFin: 12 }] },
    ];
